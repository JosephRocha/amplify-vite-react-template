...
function App() {
  ...
  const [StockPrice, setStockPrice] = useState({ "description": "", "icon": "", "name": "", "last_price": "", "price_diff": 0, "price_diff_perc": "", "last_close": 0, "ytd_prices": [], "ytd_labels": [], "revenues_labels": [], "revenues": [], "net_income_loss_labels": [], "net_income_loss": [], "eps": [], "eps_labels": [], "weekly_price_labels": [], "weekly_price": [], "monthly_price_labels": [], "monthly_price": [] });
                ...
                <div className="container">
                    ...
                    <div className="col">
                      <div id="ChartCard" className="card">
                        <div className="card-body">
                          ...
                          <h5 className="card-title">Daily Chart</h5>
                          <div id="Chart">
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <div id="ChartCard" className="card">
                        <div className="card-body">
                          <button id="ExpandCard" type="button" className="btn btn-dark" onClick={() => expandModal(<Line options={options} data={weekly_price_data} />, "7 Day Price")}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrows-angle-expand" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707m4.344-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707" />
                          </svg></button>
                          <h5 className="card-title">7 Day Price</h5>
                          <div id="Chart3">
                            <Line options={options} data={weekly_price_data} />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col">
                      <div id="ChartCard" className="card">
                        <div className="card-body">
                          <button id="ExpandCard" type="button" className="btn btn-dark" onClick={() => expandModal(<Line options={options} data={monthly_price_data} />, "30 Day Price")}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrows-angle-expand" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707m4.344-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707" />
                          </svg></button>
                          <h5 className="card-title">30 Day Price</h5>
                          <div id="Chart3">
                            <Line options={options} data={monthly_price_data} />
                          </div>
                        </div>
                      </div>
                    </div>
